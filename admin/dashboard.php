                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-footer rounded-bottom">
                                    <span><a href="index.php?view_product" class="card-link small">Xem Chi Tiết</a></span>
                                    <span class="float-right "><i class="fa fa-arrow-circle-right text-primary"></i></span>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-footer rounded-bottom">
                                    <span><a href="index.php?view_customer" class="card-link small text-success">Xem Chi Tiết</a></span>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-footer rounded-bottom">
                                    <span><a href="index.php?view_bill" class="card-link small text-info">Xem Chi Tiết</a></span>
